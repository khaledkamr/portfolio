            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex justify-center space-x-6">
                    <a href="https://twitter.com/khaledkamrr" target="_blank" rel="noopener noreferrer"
                        className="floating-3 social-icon group relative p-4 rounded-full bg-gray-800 hover:bg-black transition-all duration-300 transform hover:scale-110"
                        aria-label="Twitter" >
                    ...
                    <a href="https://github.com/khaledkamr" target="_blank" rel="noopener noreferrer"
                        className="floating social-icon group relative p-4 rounded-full bg-gray-800 hover:bg-purple-900 hover:purple-glow transition-all duration-300 transform hover:scale-110"
                        aria-label="GitHub" >
                    ...
                    <a href="https://linkedin.com/in/khaledkamr" target="_blank" rel="noopener noreferrer"
                        className="floating-2 social-icon group relative p-4 rounded-full bg-gray-800 hover:bg-blue-700 transition-all duration-300 transform hover:scale-110"
                        aria-label="LinkedIn" >
                    ...
                    <a href="mailto:khaledkamar3333@gmail.com" 
                        className="floating-3 social-icon group relative p-4 rounded-full bg-gray-800 hover:bg-red-500 transition-all duration-300 transform hover:scale-110"
                        aria-label="Email" >
