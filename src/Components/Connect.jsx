export default function Connect() {
    return (
        <div id="connect" className="relative px-6 lg:px-20 py-20">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex justify-center space-x-6">
                    <a href="https://twitter.com/khaledkamrr" target="_blank" rel="noopener noreferrer"
                        className="icon-glow group relative p-4 rounded-full bg-gray-800 hover:bg-black transition-all duration-300 transform hover:scale-110"
                        aria-label="Twitter" >
                    ...
                    <a href="https://github.com/khaledkamr" target="_blank" rel="noopener noreferrer"
                        className="icon-glow group relative p-4 rounded-full bg-gray-800 hover:bg-purple-900 hover:purple-glow transition-all duration-300 transform hover:scale-110"
                        aria-label="GitHub" >
                    ...
                    <a href="https://linkedin.com/in/khaledkamr" target="_blank" rel="noopener noreferrer"
                        className="icon-glow group relative p-4 rounded-full bg-gray-800 hover:bg-blue-700 transition-all duration-300 transform hover:scale-110"
                        aria-label="LinkedIn" >
                    ...
                    <a href="mailto:khaledkamar3333@gmail.com" 
                        className="icon-glow group relative p-4 rounded-full bg-gray-800 hover:bg-red-500 transition-all duration-300 transform hover:scale-110"
                        aria-label="Email" >
                    ...
                    <a href="https://discord.gg/khaledkamr" target="_blank" rel="noopener noreferrer"
                        className="icon-glow group relative p-4 rounded-full bg-gray-800 hover:bg-indigo-600 transition-all duration-300 transform hover:scale-110"
                        aria-label="Discord" >
            ...
            <img src={require("../Assets/astronaut-5.png")} className="absolute -bottom-4 left-[300px] w-[150px] floating-2" alt="astronaut" />
        </div>
    );
}